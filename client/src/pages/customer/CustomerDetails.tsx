...
const CustomerDetails: React.FC = () => {
  ...
  const handleContinue = () => {
    navigate('/customer/departments', {
      state: {
        customer: { fullname, email, phone, location },
      },
    });
  };
  ...
  return (
    <div className="bg-white">
      <h2 className="text-4xl px-20 py-10 font-semi-bold mb-4 text-black">Customer Details</h2>
      ...
      <div className="flex flex-col items-center justify-center px-6 py-2 mx-auto md:h-screen w-[50vw] lg:py-0">
        <form className="space-y-4 w-full md:space-y-6 text-gray-900">
