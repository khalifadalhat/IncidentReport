        ...
        <table className="w-full table-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-900 break-words whitespace-normal text-center dark:text-white">
              <button onClick={() => handleDepartmentSelect('Funding Wallet')}>
                Funding Wallet
              </button>
            </td>
          </tr>
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-900 break-words whitespace-normal text-center dark:text-white">
              <button onClick={() => handleDepartmentSelect('Buying Airtime')}>
                Buying Airtime
              </button>
            </td>
          </tr>
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-900 break-words whitespace-normal text-center dark:text-white">
              <button onClick={() => handleDepartmentSelect('Buying Internet Data')}>
          ...
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-900 break-words whitespace-normal text-center dark:text-white">
              <button onClick={() => handleDepartmentSelect('E-commerce Section')}>
                E-commerce Section
              </button>
            </td>
          </tr>
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-900 break-words whitespace-normal text-center dark:text-white">
              <button onClick={() => handleDepartmentSelect('Fraud Related Problems')}>
          ...
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            <td className="px-6 py-4 font-medium text-gray-900 break-words whitespace-normal text-center dark:text-white">
              <button onClick={() => handleDepartmentSelect('General Services')}>
                General Services
              </button>
            </td>
          </tr>
